 ...
 * @author marcin
 */
public class MissingRulesRecreator {
    ...
    public static void fromReceipe() {
        final ADIExperiment adiExperiment = new ADIExperiment("reproduction___from_all");
        ...
        String caption = "reproduction__ od wszystkich atrybut\u00F3w dla ";//"Zale\u017Cno\u015B\u0107 od wszystkich atrybut\u00F3w dla ";
