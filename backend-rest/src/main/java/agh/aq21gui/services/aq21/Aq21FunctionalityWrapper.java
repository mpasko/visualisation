...
import agh.aq21gui.filters.InvariantAttributeRemover;
...
public class Aq21FunctionalityWrapper {
    private InvariantAttributeRemover invariantAttributeRemover = new InvariantAttributeRemover();
    private Discretizer discretizer = new Discretizer();
    ...
    public Output enhancedInvoke(Input in){
        ...
        filteredData = invariantAttributeRemover.filter(filteredData);
